...
public class SettingsResponseDto {
    ...
    private final Set<String> discordWebhookUrls;
    private final Set<String> slackWebhookUrls;
    private final Set<String> teamsWebhookUrls;
    ...
    public Set<String> getDiscordWebhookUrls() { return discordWebhookUrls; }

    public Set<String> getSlackWebhookUrls() { return slackWebhookUrls; }

    public Set<String> getTeamsWebhookUrls() { return teamsWebhookUrls; }
}
