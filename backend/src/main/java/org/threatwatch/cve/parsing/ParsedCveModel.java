package org.threatwatch.cve.parsing;

import org.threatwatch.cve.model.Severity;
...
public class ParsedCveModel {
    ...
    public ParsedCveModel(String cveId, String description, Severity severity, String score, String published, List<String> references) {
        this.cveId = cveId;
